...
public class UniversityPanel extends javax.swing.JPanel implements Panel {
   ...
   private static UniversityPanel instance;
    ...
    public void reloadTable() {
        SchoolController.initialData();
        SchoolController.initialModel();
        viewTable.setModel(SchoolController.getModel());
    }
    
    @Override
    public void actionAdd() {
        new UniversityDialog(null).setVisible(true);
    }
    ...
    public void actionEdit() {
        ...
        new UniversityDialog(SchoolController.showFullInfo(t)).setVisible(true);
    }
...
//        new UniversitySearchDialog().setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Quản Lý Trường Học");
        ...
        txtSearch.setText("Nhập mã trường");

...
public class RoomPanel extends JPanel implements Panel {
    ...
    public void actionEdit() {
        ...
        String room = (String)viewTable.getModel().getValueAt(viewTable.getSelectedRow(), 1);
        String building = (String)viewTable.getModel().getValueAt(viewTable.getSelectedRow(), 2);
    ...
    public void actionDelete() {
        ...
        for (String[] s : listIDRoom) {
            if (RoomManageController.delData(s[1], s[2])) {
                ++count;
            }
        }

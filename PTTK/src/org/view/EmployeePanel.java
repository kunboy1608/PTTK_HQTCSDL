...
public class EmployeePanel extends javax.swing.JPanel {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        new EmployeeDialog(viewTable.getSelectedRow()).setVisible(true);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        for (int i = 0; i < viewTable.getRowCount(); i++) {
            if (viewTable.isRowSelected(i)) {
                EmployeeController.getInstance().delete((String) table.getValueAt(i, 1));
                //xóa dòng được chọn khỏi bảng và cập nhật bảng
                viewTable.setModel(EmployeeController.getInstance().toTable());
                return;
            }
        }

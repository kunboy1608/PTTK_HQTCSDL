...
public class StudentSearchDialog extends javax.swing.JFrame {
    ...
    public StudentSearchDialog() throws HeadlessException {
        this.setLocationRelativeTo(StudentPanel.getInstance());
    ...
    private void actionSearch() {
        Searcher searcher = new Searcher(
            (DefaultTableModel) StudentPanel.getInstance().getTableModel()
                             // [-------] Change the panel here
        );
    ...
    private void initComponents() {
        ...
        txtExpDate.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N
        ...
        txtSchool.setFont(new java.awt.Font("Courier New", 0, 14)); // NOI18N

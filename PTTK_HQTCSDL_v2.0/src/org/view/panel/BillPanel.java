...
public class BillPanel extends JPanel implements Panel {
    ...
    private static BillPanel instance = new BillPanel();
    ...
    public void resizeColumnTable() {
        ...
        this.viewTable.getColumnModel().getColumn(1).setMinWidth(150);
        this.viewTable.getColumnModel().getColumn(2).setMinWidth(80);
        this.viewTable.getColumnModel().getColumn(3).setMinWidth(80);
        this.viewTable.getColumnModel().getColumn(4).setMinWidth(80);
        ...
        this.viewTable.getColumnModel().getColumn(8).setMinWidth(150);
        this.viewTable.getColumnModel().getColumn(9).setMinWidth(100);
        
        this.viewTable.getColumnModel().getColumn(10).setMinWidth(100);
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(JLabel.LEFT);
        this.viewTable.getColumnModel().getColumn(8).setCellRenderer(centerRenderer);
    }
